...
*/
export default function AccountItemStateMachine({ index = 0,  QueMachine, api = null, 
initial = 'idle' }) {
    const MachineAPI = api ? api : AccountItemServices({ api });
        ...
        states: {
          ...
          starting: {
            invoke: {
              ...
              src: AccountItemLaunchMachine({ index, api }),
              onDone: {
                target: 'idle',
              }
            },
          ...
          authenticate: {
            invoke: {
              ...
              src: AccountItemAuthMachine({ index, api }),
              onDone: {
                target: 'idle',
              }
            },
